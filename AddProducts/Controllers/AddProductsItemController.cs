...
namespace AddProducts.Controllers
{
    public class AddProductsItemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Task,Completed")] AddProductsItem AddProductsItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Task,Completed")] AddProductsItem AddProductsItem)
        {
